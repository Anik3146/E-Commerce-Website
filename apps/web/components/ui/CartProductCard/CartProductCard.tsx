...
export function CartProductCard({
  ...
  useEffect(() => {
    let updatedTotal = total - cart[index].selling_price * cart[index].count;
    cart[index].count = count;
    updatedTotal += cart[index].selling_price * count;
        ...
        <div className="my-2 sm:mb-0">
          <ul className="text-xs font-normal leading-5 sm:typography-text-sm text-neutral-700">
            <li>
              ...
              <span className="font-medium">"attribute level"</span>
            </li>
          </ul>
        </div>
